  ...
  return [
    ...
    },
    {
      ...
      detail: {
        ...
        why_it_matters: '',
        known: [],
        uncertain: ['how markets will respond in coming days', 'what guidance companies will provide'],
    ...
    },
    {
      ...
      detail: {
        ...
        why_it_matters: '',
        known: [],
        uncertain: ['whether the findings will lead to new treatments', 'how long clinical applications might take'],
    ...
    },
    {
      ...
      detail: {
        ...
        why_it_matters: '',
        known: [],
        uncertain: ['whether the proposal will pass in its current form', 'what amendments may be introduced'],
